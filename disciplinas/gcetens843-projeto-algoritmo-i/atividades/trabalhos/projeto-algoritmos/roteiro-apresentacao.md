...
> **Status:** 🔒 Pendente — slides sendo elaborados por Uélinton + Wallace  
...
|:-:|:------|:----------|:-------:|
| 1 | **Capa** — MinhaFila, disciplina, integrantes | Deivison ou Uélinton | 30s |
...
| 5 | **Proposta MinhaFila** — solução multissetorial, como funciona | Núbia | 2min |
...
| 8 | **Protótipo de telas** — demonstração visual | Deivison | 2min |
| 9 | **Conclusão** — impacto esperado, limitações, próximos passos | Rios ou Deivison | 1min |

> **Observação:** Uélinton e Wallace são os responsáveis pela criação dos slides. O roteiro acima é uma sugestão de divisão — a equipe pode ajustar conforme a produção dos slides.
