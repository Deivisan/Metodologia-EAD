# CORE - Prompts Individuais de Apresentacao

> Projeto: MinhaFila - GCETENS843 - Projeto Algoritmo I
> Apresentacao: 29/06/2026 as 20h - AO VIVO
> Duracao total: 13-15 minutos
> Fonte dos slides: MinhaFila_Smart_Waiting (3).pdf - 14 paginas

## Estrutura dos 14 Slides
...
| 11 | Dashboard de Transparencia (TV + Equipe) | Deivison | 1min |
| 12 | Beneficios (64%, US$ 2M, conformidade, bem-estar) | Rios | 1min |
...
1. Criar arquivo <nome-slug>.md quando alguem confirmar
2. Atualizar tabela com slides + status
3. Rebalancear slides se mais gente entrar
4. Commit + push com mensagem semantica

---

*Ultima atualizacao: 29/06/2026 - baseado no PDF MinhaFila_Smart_Waiting (3).pdf*
