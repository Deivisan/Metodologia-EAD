# Index Geral — MinhaFila

> Documento central do grupo. Reúne o status do projeto, integrantes, entregáveis e roadmap.
...
| **Semestre** | 2026.1 |
| **Tema** | Solução de Gerenciamento Inteligente de Filas para Múltiplos Setores |
| **Apresentação final** | **29/06/2026 às 20h** |

> [Tema completo](tema-escolhido.md) · [Divisão de tarefas](divisao-de-tarefas.md) · [Decisões do projeto](decisoes.md) · [Protótipo](prototipo-minhafila/index.html)
...
O problema real está fundamentado em literatura consolidada (Aggarwal, Chianca, Clemente, Farias, Giannotti, Ha, Jonsson, Kessel, Melo, Thompson, entre outros). A pergunta central que orienta o projeto:

*"Como reduzir o tempo de permanência física dos usuários em filas de diferentes setores e aumentar a previsibilidade do atendimento por meio de uma solução digital acessível?"*
